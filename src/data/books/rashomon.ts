...
export const rashomonSimplifiedParts: string[] = [
  `ある日の夕方のことです。一人の若い男が、羅生門という大きな門の下で、雨がやむのを待っていました。広い門の下には、この男のほかに誰もいません。

この二、三年、京都の町では、地震や火事などの災害がたくさんありました。そのため、町はとても貧しくなっていました。誰もこの大きな門を直しません。門が古くなると、動物や泥棒が住むようになりました。そして、死んだ人をこの門に捨てるようになりました。ですから、夕方になると、みんな怖がって門の近くに来なくなりました。`,

  `男は、数日前に仕事の主人から「もう来なくていい」と言われました。男は仕事がなくなり、これからどうやって生きていけばいいかわかりませんでした。「このまま何もしなければ死んでしまう。でも、泥棒になるのは嫌だ」と考えながら、男は冷たい雨を見ていました。

夜になって寒くなってきたので、男は門の上の部屋で寝ようと思いました。上には死んだ人しかいないはずです。男は静かに階段を登りました。`,

  `しかし、一番上まで登ると、部屋の中に火の光が見えました。こんな夜に火を使っているのは不思議です。男はそっと中を見ました。

部屋の中には、死んだ人がたくさん倒れていました。そして、その中に一人のおばあさんがいました。おばあさんは、死んだ女の人の長い髪の毛を一本ずつ抜いていました。`,

  `男はそれを見て、とても怒りました。「死んだ人の髪を抜くなんて、なんて悪い人だ！」と思いました。男は刀を持って、おばあさんの前に飛び出しました。

「何をしている！言いなさい！」男は怒鳴りました。`,
...
export const rashomonIntermediateParts: string[] = [
  `ある日の夕方のことである。一人の男が、羅生門の下で雨がやむのを待っていた。広い門の下には、この男のほかに誰もいない。ただ、色がはげた大きな柱に、キリギリスが一匹とまっているだけだ。羅生門は大通りにあるので、ほかにも雨宿りをする人がいそうだが、誰もいない。
...
その代わり、カラスがたくさん集まってきた。カラスは門の上の死体の肉を食べに来るのだ。しかし今日は時間が遅いせいか、一羽も見えない。ただ、崩れかけた石段の上に、カラスのフンが白くついているのが見える。男は七段ある石段の一番上に座り、ぼんやりと雨が降るのを見ていた。`,

  `男は数日前に、長く働いていた主人からクビにされた。当時の京都の町はすっかり衰えていたので、これもその影響だった。男はこれからどうやって生きていけばいいのか分からず、途方に暮れていた。

「飢え死にをするか、泥棒になるか」。男は何度も考えたが、どうしても泥棒になる勇気は出なかった。

寒くなってきたので、男は風や雨をしのげて、人目につかない場所で夜を明かそうと思った。そこで、門の上の階へ上がるはしごを登ることにした。上には死体しかないはずだ。`,

  `しかし、はしごを登っていくと、上で誰かが火をともしているのが見えた。こんな雨の夜に、こんな場所で火を使うのは普通の人間ではない。男は足音を立てずに一番上まで登り、中の様子をのぞいた。

噂の通り、いくつもの死体が床に転がっていた。腐った臭いに男は鼻を押さえたが、次の瞬間、その手を下ろした。死体の中に、一人の人間がうずくまっているのを見たからだ。

それは、サルのような背の低い老婆だった。老婆は松の木に火をつけて、若い女の死体の顔をのぞき込んでいた。そして、その死体の長い髪の毛を一本ずつ抜き始めたのだ。`,

  `男は恐怖と好奇心で息をするのも忘れた。そして、老婆に対する激しい憎しみが湧いてきた。あらゆる悪に対する怒りだと言ってもいい。もしこの時、誰かが「飢え死にするか、泥棒になるか」と聞いたら、男は迷わず飢え死にを選んだだろう。それほど、悪を憎む気持ちが強くなっていた。
...
男はその平凡な答えにがっかりし、再び冷たい軽蔑の気持ちを持った。老婆はさらに言い訳をした。`,

  `「死人の髪を抜くのは悪いことかもしれない。しかし、ここにいる死人たちも、生きるために悪いことをしてきた人間ばかりだ。私が髪を抜いたこの女も、蛇の肉を干し魚だと嘘をついて売っていた。そうしなければ飢え死にしていたからだ。だから、私がすることも大目に見てくれるだろう。」

これを聞いて、男の心にある勇気が生まれた。それは、さっき老婆を捕まえた時の勇気とは全く逆のものだった。男の心から「飢え死に」という考えは完全に消え去っていた。`,
...
export const rashomonOriginalParts: string[] = [
