// 羅生門 — Akutagawa Ryūnosuke
// Three difficulty versions split into 6 narrative parts (synchronized across levels).
// Original: Aozora Bunko, paragraph-split.

export const rashomonSimplifiedParts: string[] = [`ある日の夕方のことです。一人の若い男が、羅生門という大きな門の下で、雨がやむのを待っていました。広い門の下には、この男のほかに誰もいません。

この二、三年、京都の町では、地震や火事などの災害がたくさんありました。そのため、町はとても貧しくなっていました。誰もこの大きな門を直しません。門が古くなると、動物や泥棒が住むようになりました。そして、死んだ人をこの門に捨てるようになりました。ですから、夕方になると、みんな怖がって門の近くに来なくなりました。`,`男は、数日前に仕事の主人から「もう来なくていい」と言われました。男は仕事がなくなり、これからどうやって生きていけばいいかわかりませんでした。「このまま何もしなければ死んでしまう。でも、泥棒になるのは嫌だ」と考えながら、男は冷たい雨を見ていました。

夜になって寒くなってきたので、男は門の上の部屋で寝ようと思いました。上には死んだ人しかいないはずです。男は静かに階段を登りました。`,`しかし、一番上まで登ると、部屋の中に火の光が見えました。こんな夜に火を使っているのは不思議です。男はそっと中を見ました。

部屋の中には、死んだ人がたくさん倒れていました。そして、その中に一人のおばあさんがいました。おばあさんは、死んだ女の人の長い髪の毛を一本ずつ抜いていました。`,`男はそれを見て、とても怒りました。「死んだ人の髪を抜くなんて、なんて悪い人だ！」と思いました。男は刀を持って、おばあさんの前に飛び出しました。

「何をしている！言いなさい！」男は怒鳴りました。`,`おばあさんは震えながら言いました。
「この髪を抜いて、かつらを作るつもりでした。悪いことかもしれませんが、ここにある死体も、生きていた時は悪いことをしていました。私が髪を抜いているこの女も、生きるために、蛇の肉を魚の肉だとうそをついて売っていました。そうしないと死んでしまうからです。だから、私が生きるために髪を抜くことも、許してくれるでしょう。」

おばあさんの話を聞いて、男の気持ちが変わりました。男は「生きるためには、悪いことをしてもいいのだな」と思いました。

「そうか」`,`男はおばあさんの服を力強くつかみました。

「じゃあ、俺がお前の服を盗んでも怒るなよ。俺もそうしないと死んでしまうからだ。」

男は、おばあさんの服を脱がせて盗みました。そして、おばあさんを蹴って、暗い階段を急いで降りていきました。

おばあさんが後で門の下を見ましたが、外は真っ暗でした。男がどこへ行ったのか、誰も知りません。`,
];

export const rashomonIntermediateParts: string[] = [`ある日の夕方のことである。一人の男が、羅生門の下で雨がやむのを待っていた。広い門の下には、この男のほかに誰もいない。ただ、色がはげた大きな柱に、キリギリスが一匹とまっているだけだ。羅生門は大通りにあるので、ほかにも雨宿りをする人がいそうだが、誰もいない。

なぜかというと、この数年、京都では地震や火事、飢饉などの災害が続いていたからだ。町はひどくさびれていた。古い記録によると、仏像を壊して薪として売っていたほどだという。だから、羅生門を修理する人など誰もいなかった。門が荒れ果てると、キツネやタヌキが住みつき、泥棒が住みついた。最後には、引き取り手のない死体をこの門に捨てていく習慣までできた。そのため、夕方になると気味悪がって誰も近づかなくなった。

その代わり、カラスがたくさん集まってきた。カラスは門の上の死体の肉を食べに来るのだ。しかし今日は時間が遅いせいか、一羽も見えない。ただ、崩れかけた石段の上に、カラスのフンが白くついているのが見える。男は七段ある石段の一番上に座り、ぼんやりと雨が降るのを見ていた。`,`男は数日前に、長く働いていた主人からクビにされた。当時の京都の町はすっかり衰えていたので、これもその影響だった。男はこれからどうやって生きていけばいいのか分からず、途方に暮れていた。

「飢え死にをするか、泥棒になるか」。男は何度も考えたが、どうしても泥棒になる勇気は出なかった。

寒くなってきたので、男は風や雨をしのげて、人目につかない場所で夜を明かそうと思った。そこで、門の上の階へ上がるはしごを登ることにした。上には死体しかないはずだ。`,`しかし、はしごを登っていくと、上で誰かが火をともしているのが見えた。こんな雨の夜に、こんな場所で火を使うのは普通の人間ではない。男は足音を立てずに一番上まで登り、中の様子をのぞいた。

噂の通り、いくつもの死体が床に転がっていた。腐った臭いに男は鼻を押さえたが、次の瞬間、その手を下ろした。死体の中に、一人の人間がうずくまっているのを見たからだ。

それは、サルのような背の低い老婆だった。老婆は松の木に火をつけて、若い女の死体の顔をのぞき込んでいた。そして、その死体の長い髪の毛を一本ずつ抜き始めたのだ。`,`男は恐怖と好奇心で息をするのも忘れた。そして、老婆に対する激しい憎しみが湧いてきた。あらゆる悪に対する怒りだと言ってもいい。もしこの時、誰かが「飢え死にするか、泥棒になるか」と聞いたら、男は迷わず飢え死にを選んだだろう。それほど、悪を憎む気持ちが強くなっていた。

男は刀に手をかけ、老婆の前に飛び出した。老婆は驚いて逃げようとしたが、男は老婆をねじ倒し、刀を突きつけた。

「何をしていた！言わないと斬るぞ！」

老婆は震えながら、カラスのような声で答えた。

「この髪を抜いて、かつらを作ろうと思ったのだ。」

男はその平凡な答えにがっかりし、再び冷たい軽蔑の気持ちを持った。老婆はさらに言い訳をした。`,`「死人の髪を抜くのは悪いことかもしれない。しかし、ここにいる死人たちも、生きるために悪いことをしてきた人間ばかりだ。私が髪を抜いたこの女も、蛇の肉を干し魚だと嘘をついて売っていた。そうしなければ飢え死にしていたからだ。だから、私がすることも大目に見てくれるだろう。」

これを聞いて、男の心にある勇気が生まれた。それは、さっき老婆を捕まえた時の勇気とは全く逆のものだった。男の心から「飢え死に」という考えは完全に消え去っていた。`,`「本当にそうだな。」

男は老婆の胸倉をつかんで言った。

「じゃあ、俺が身ぐるみ剥いでも恨むなよ。俺もそうしなければ飢え死にする体なのだ。」

男は素早く老婆の着物を剥ぎ取り、すがりつこうとする老婆を蹴り倒した。そして、剥ぎ取った着物を抱えて、急なはしごを一気に駆け下りた。

しばらくして、老婆は起き上がり、門の下をのぞき込んだ。しかし外には真っ暗な夜があるだけだった。男がどこへ行ったのかは、誰も知らない。`,
];

export const rashomonOriginalParts: string[] = [`ある日の暮方の事である。一人の下人が、羅生門の下で雨やみを待っていた。
...
下人は、老婆が死骸につまずきながら、慌てふためいて逃げようとする行手を塞いで、こう罵った。老婆は、それでも下人をつきのけて行こうとする。下人はまた、それを行かすまいとして、押しもどす。二人は死骸の中で、しばらく、無言のまま、つかみ合った。しかし勝敗は、はじめからわかっている。下人はとうとう、老婆の腕をつかんで、無理にそこへ第4水準2-12- じ倒した。丁度、鶏の脚のような、骨と皮ばかりの腕である。

「何をしていた。云え。云わぬと、これだぞよ。」`,`下人は、老婆をつき放すと、いきなり、太刀の鞘を払って、白い鋼の色をその眼の前へつきつけた。けれども、老婆は黙っている。両手をわなわなふるわせて、肩で息を切りながら、眼を、眼球がの外へ出そうになるほど、見開いて、唖のように執拗く黙っている。これを見ると、下人は始めて明白にこの老婆の生死が、全然、自分の意志に支配されていると云う事を意識した。そうしてこの意識は、今までけわしく燃えていた憎悪の心を、いつの間にか冷ましてしまった。後に残ったのは、ただ、ある仕事をして、それが円満に成就した時の、安らかな得意と満足とがあるばかりである。そこで、下人は、老婆を見下しながら、少し声を柔らげてこう云った。
...
export const rashomonSimplified = rashomonSimplifiedParts.join('\n\n');
export const rashomonIntermediate = rashomonIntermediateParts.join('\n\n');
export const rashomonOriginal = rashomonOriginalParts.join('\n\n');
