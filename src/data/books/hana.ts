...
export const hanaSimplifiedParts: string[] = [
  `池の尾という町で、内供というお坊さんを知らない人はいません。内供の鼻はとても長いです。15センチぐらいあります。口の上からあごの下まで垂れています。細くて長いソーセージのようです。
...
でも、内供の一番の悩みは、心の問題でした。町の人たちは「あのお坊さんは、あんな鼻だから、結婚できないね。お坊さんになってよかったね」と言いました。内供はそれを聞いて、とても悲しかったです。プライドが傷つきました。`,
  `内供は、鼻を短く見せる方法をたくさん考えました。鏡の前で、顔の向きを変えたり、手で顔を触ったりしました。でも、いつも短く見えなくて、がっかりしました。他の人の顔を見て、「私と同じ長い鼻の人がいるかな」と探しました。でも、いませんでした。昔の古い本も読みましたが、長い鼻の人の話はありませんでした。

鼻を短くする薬もたくさん使いました。草を煮て飲んだり、ネズミのおしっこを塗ったりしました。でも、鼻はずっと15センチのままでした。

ある秋、弟子が京都へ行きました。そして、お医者さんに「鼻を短くする方法」を聞いてきました。内供は、最初は「そんなことはしたくない」と言いましたが、本当はとてもやりたかったです。だから、やってみることにしました。`,
  `方法は簡単です。熱いお湯の中に鼻を入れて、その後、他の人に足で鼻を踏んでもらいます。内供は、お湯を沸かして、その中に鼻を入れました。鼻が赤くなりました。
...
お湯から鼻を出して、鏡を見ました。内供はびっくりしました。あんなに長かった鼻が、普通の人の鼻と同じくらい短くなっていたからです。内供はとても嬉しくて、「これで、もう誰も笑わない」と安心しました。`,
  `しかし、二、三日すると、変なことに気がつきました。お寺に来る人が、前よりも変な顔をして、内供の顔を見ます。若いお坊さんたちも、内供を見て、クスクス笑います。鼻が長かった時より、今のほうがみんな遠慮なく笑っているのです。
...
export const hanaIntermediateParts: string[] = [
  `禅智内供というお坊さんの鼻について、池の尾という町で知らない人はいない。長さは十五センチくらいあって、上唇の上からあごの下まで下がっている。形は、付け根も先も同じように太い。細長いソーセージのようなものが、顔の真ん中からぶら下がっているのだ。
...
しかし、これは内供にとって一番の悩みではない。内供が本当に苦しんでいたのは、この鼻のせいで傷つく自分の「自尊心」だった。池の尾の町の人々は、内供の鼻を見て、「あのお坊さんは奥さんをもらわなくてよかった」と言った。あんな鼻では誰も結婚しないだろうと思ったからだ。内供はこの鼻のせいで、お坊さんになったことを少しも後悔していなかった。しかし、周りの人の目や言葉は、内供のプライドを深く傷つけた。`,
  `だから内供は、何とかしてこの傷ついたプライドを治そうと、色々な方法を試した。まず、鏡の前で色々な角度から顔を見て、鼻が短く見えないか試した。顔の向きを変えたり、手で頬を押さえたりして、少しでも短く見える角度を探したが、いつもがっかりして終わった。また、他人の顔をよく観察して、自分と同じような鼻の人がいないか探した。しかし、曲がった鼻の人はいても、内供のように長い鼻の人は一人もいなかった。そして、本を読んで、昔の偉い人の中に長い鼻の人がいなかったか探したが、そんな話はどこにも書いていなかった。

もちろん、内供はただ気休めを探すだけでなく、実際に鼻を短くする方法もたくさん試した。カラスウリという植物を煮て飲んでみたり、ネズミの尿を鼻に塗ってみたりした。しかし、何をしても、鼻は十五センチの長さのまま、顔の真ん中からぶら下がっていた。

ある年の秋、内供の用事で京都へ行った弟子が、知り合いのお医者さんから、鼻を短くする良い方法を教わってきた。そのお医者さんは中国から来た人で、京都のお寺で働いていた。内供はいつものように、鼻なんか気にしていないという態度をとって、すぐにはその方法を試そうとしなかった。しかし、弟子が熱心に勧めるので、とうとうその方法を試すことにした。`,
  `その方法というのは、とても簡単なものだった。ただ、鼻を熱いお湯で茹でて、それを人に足で踏んでもらうという方法だ。お寺でお湯を沸かし、お盆に穴を開けて、その穴から鼻を熱いお湯の中に入れた。しばらくして、鼻をお湯から出すと、鼻は赤く茹で上がっていた。
...
お湯から出した鼻を見て、内供は驚いた。あの長かった鼻が、普通の人の鼻と同じくらい短くなっていたのだ。もう上唇の上までしか垂れ下がっていない。内供は鏡を見て、自分の鼻が普通になったことを確認した。鏡の中の顔は、とても満足そうだった。「これで、もう誰も笑わないだろう」内供は心の中でそう思い、とても安心した。`,
  `しかし、二、三日して、内供は不思議なことに気がついた。お寺の用事でお経を読みに来たお侍さんが、内供の顔を見て、前よりもおかしいというような顔をして、じっと見つめていたのだ。それだけではない。内供の世話をしている小坊主たちも、内供の前でクスクスと笑いをこらえているようだった。前は、長い鼻を見てみんな驚いていたが、今は、鼻が短くなったことで、逆に遠慮なく面白がっているようだった。
...
export const hanaOriginalParts: string[] = [
