...
export const hanaSimplified = `池の尾という町で、内供というお坊さんを知らない人はいません。内供の鼻はとても長いです。15センチぐらいあります。口の上からあごの下まで垂れています。細くて長いソーセージのようです。
...
export const hanaIntermediate = `禅智内供というお坊さんの鼻について、池の尾という町で知らない人はいない。長さは十五センチくらいあって、上唇の上からあごの下まで下がっている。形は、付け根も先も同じように太い。細長いソーセージのようなものが、顔の真ん中からぶら下がっているのだ。
...
export const hanaOriginal = `禅智内供の鼻と云えば、池の尾で知らない者はない。長さは五六寸あって上唇の上から顋の下まで下っている。形は元も先も同じように太い。云わば細長い腸詰めのような物が、ぶらりと顔のまん中からぶら下っているのである。
