      ...
      <div className="relative z-50 w-full max-w-lg max-h-[85vh] overflow-y-auto rounded-t-2xl sm:rounded-2xl bg-card shadow-2xl ring-1 ring-border/40 animate-fade-in">
        ...
        >
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-muted-foreground">Reader</p>
                  ...
                  >
                    ...
                    {expanded && (
                      <div className="mt-4 space-y-4 animate-in fade-in">
                        <div>
                          <p className="font-serif text-[12px] font-semibold text-foreground/70">Example from text</p>
                        ...
                        <div>
                          <p className="font-serif text-[12px] font-semibold text-foreground/70">Tip</p>
                          <span className="mt-1 mb-2 block h-px w-6 bg-foreground/30" />
