...
export function FlashcardReview({ deck, onExit }: Props) {
 ...
 <button
 onClick={() => advance()}
 className="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground/70 transition-colors px-5 py-2.5 rounded-full border border-border/60 bg-card/60 backdrop-blur-sm"
 >
 Skip
 </button>
 )}
