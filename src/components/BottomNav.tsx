...
export function BottomNav() {
 ...
 <div className="nav-dock relative flex items-center justify-between rounded-full border border-border/40 bg-card/55 px-1.5 py-1.5 backdrop-blur-xl">
 ...
 className="nav-pill-active absolute inset-0 overflow-hidden rounded-full"
