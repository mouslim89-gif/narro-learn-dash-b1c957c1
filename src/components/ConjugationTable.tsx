...
const GODAN_MAP: Record<string, { i: string; a: string; e: string; o: string; te: string; ta: string }> = {'う': { i:'い', a:'わ', e:'え', o:'お', te:'って', ta:'った'},'く': { i:'き', a:'か', e:'け', o:'こ', te:'いて', ta:'いた'},'ぐ': { i:'ぎ', a:'が', e:'げ', o:'ご', te:'いで', ta:'いだ'},'す': { i:'し', a:'さ', e:'せ', o:'そ', te:'して', ta:'した'},'つ': { i:'ち', a:'た', e:'て', o:'と', te:'って', ta:'った'},'ぬ': { i:'に', a:'な', e:'ね', o:'の', te:'んで', ta:'んだ'},'ぶ': { i:'び', a:'ば', e:'べ', o:'ぼ', te:'んで', ta:'んだ'},'む': { i:'み', a:'ま', e:'め', o:'も', te:'んで', ta:'んだ'},'る': { i:'り', a:'ら', e:'れ', o:'ろ', te:'って', ta:'った'},
};
...
export function ConjugationTable({ dictForm, partsOfSpeech, alwaysOpen = false, hideLabel = false }: ConjugationTableProps) {
 ...
 i % 2 === 0 ?'bg-muted/30':'bg-background'} ${i === 0 ?'bg-primary/10':''}`}
 >
 ...
 <CollapsibleTrigger className="flex w-full items-center justify-between rounded-lg bg-muted/50 px-3 py-2.5 text-sm font-semibold text-foreground smooth-colors tap-scale-sm my-[10px]">
