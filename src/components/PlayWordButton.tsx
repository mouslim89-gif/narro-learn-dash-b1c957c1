...
export function PlayWordButton({ word, reading, className ='', size = 18 }: PlayWordButtonProps) {
 ...
 <button
 onClick={play}
 className={`inline-flex items-center justify-center rounded-full p-1.5 text-muted-foreground smooth-colors tap-scale-sm ${
 state ==='playing'?'text-accent animate-soft-pulse':''} ${className}`}
