      ...
      >
        <div className="flex items-center gap-3 min-w-0">
          <button
            ...
            aria-label="Back"
            className="h-10 w-10 rounded-full relief-raised bg-background/80 backdrop-blur-md ring-1 ring-border/40 flex items-center justify-center smooth-colors tap-scale-sm"
          >
