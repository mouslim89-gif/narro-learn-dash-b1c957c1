...
export default function Settings() {
 ...
 aria-label="Back"
 className="h-10 w-10 rounded-full bg-background/70 backdrop-blur-md ring-1 ring-border/40 shadow-sm flex items-center justify-center smooth-colors tap-scale-sm"
 >
