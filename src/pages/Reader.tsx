          ...
          <div className="flex flex-col gap-5">
            ...
            <SettingsSection label="Font size">
              <SegmentedRow<FontSize>
                value={fontSize}
                options={[...fontSizes]}
                labels={fontSizes.map((s) => (
                  <span key={s} className="inline-flex items-center justify-center gap-1">
            ...
            <SettingsSection label="Japanese font">
              <SegmentedRow<JapaneseFont>
                ...
                labels={japaneseFonts.map((f) => (
                  <span key={f.value} className="inline-flex items-center justify-center gap-1.5">
            ...
            <SettingsSection label="Theme">
              <SegmentedRow<'light' | 'dark'>
                ...
                options={['light', 'dark']}
                labels={[
                  <span key="l" className="inline-flex items-center justify-center gap-1.5"><Sun className="h-3.5 w-3.5" /> Light</span>,
                  <span key="d" className="inline-flex items-center justify-center gap-1.5"><Moon className="h-3.5 w-3.5" /> Dark</span>,
                ]}
            ...
            <SettingsSection label="Display mode">
              <SegmentedRow<DisplayMode>
                value={displayMode}
                options={['normal', 'grammar']}
                labels={[
                  'Normal',
                  <span key="g" className="inline-flex items-center justify-center gap-1.5"><Palette className="h-3 w-3" /> Grammar</span>,
                ]}
