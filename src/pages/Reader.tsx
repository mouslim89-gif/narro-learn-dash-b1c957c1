...
export default function Reader() {
 ...
 className={cn('card-lift tap-scale w-full rounded-xl border bg-card p-4 text-left ring-1 transition-colors',
 ...
 <article ref={articleRef} className="mx-3 my-5 overflow-hidden rounded-2xl bg-card shadow-sm shadow-inner-sm ring-1 ring-border/30 sm:mx-auto sm:max-w-2xl">
